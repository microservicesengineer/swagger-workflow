...
public interface BpmnProcessDefinitionManagmentApi {
    ...
    @ApiOperation(value = "根据deployment ID删除", nickname = "deleteProcessById", notes = "", response = StandardResponse.class, tags={ "bpmn process definition managment","Processdefinition", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "部署预定义的bpmn文件", nickname = "deployDefinedProcess", notes = "", response = StandardResponse.class, tags={ "bpmn process definition managment","Processdefinition", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "获取部署列表", nickname = "getDeploymentList", notes = "", response = StandardResponse.class, tags={ "bpmn process definition managment","Processdefinition", })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<StandardResponse> getDeploymentList() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"code\" : 0,  \"data\" : \"{}\",  \"message\" : \"message\"}", StandardResponse.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    @ApiOperation(value = "根据deployment ID查询详情", nickname = "getProcessById", notes = "", response = StandardResponse.class, tags={ "bpmn process definition managment","Processdefinition", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "get deployment by id", response = StandardResponse.class) })
    @RequestMapping(value = "/processDefinition/deploy/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<StandardResponse> getProcessById(@ApiParam(value = "",required=true) @PathVariable("id") Integer id) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"code\" : 0,  \"data\" : \"{}\",  \"message\" : \"message\"}", StandardResponse.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    @ApiOperation(value = "上传 bpmn zip 文件部署", nickname = "uploadZip", notes = "", response = StandardResponse.class, tags={ "bpmn process definition managment","Processdefinition", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "upload bpmn file  successfully", response = StandardResponse.class) })
