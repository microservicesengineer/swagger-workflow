...
public class InlineResponse2002   {
  ...
  @JsonProperty("data")
  @Valid
  private List<ProcessInstanceEntity> data = null;
  ...
  **/
  ...
  public InlineResponse2002 data(List<ProcessInstanceEntity> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2002 addDataItem(ProcessInstanceEntity dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<ProcessInstanceEntity> getData() {
    return data;
  }

  public void setData(List<ProcessInstanceEntity> data) {
    this.data = data;
  }
